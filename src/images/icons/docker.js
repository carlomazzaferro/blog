...
<path style="fill:#006BC0;" d="M512,256c0,141.385-114.615,256-256,256S0,397.385,0,256S114.615,0,256,0
...
let DockerIcon
export default DockerIcon = props => (
  <Icon component={Docker} {...props} />
)
